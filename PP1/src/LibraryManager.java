        ...
        try{
            ...
            while (readFile.hasNextLine()){
                ...
                if(callNum.charAt(0) == ('B')){
                    ...
                    Catalog addition = new Publication(title, publisher, year, copies, type, callNum, month, issue);
                    Catalog.add(catalogList, addition);
                }
            }
            readFile.close();
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    if(typeAdded.equals("Book")){
                        ...
                        Catalog welit = new Publication(titleAdded, pubAdded, yearAdded, numCopAdded, typeAdded, callNumber, monthAdded, issueAdded);
                        Catalog.add(catalogList, welit);
                        ...
                        for (Catalog catalog : catalogList) {
                            if (catalog != null) {
                                ...
                                if (catalog.getType().equalsIgnoreCase("Book")) {
                                    ...
                                    Publication it = (Publication) catalog;
